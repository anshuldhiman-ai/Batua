...
export default function Settings() {
  ...
  return (
    <div className="page-enter max-w-6xl space-y-6">
      <PageHeader
        title="Settings"
        subtitle="Appearance, preferences and data management"
      />

      {/* Landscape layout — cards flow across two columns on wide screens
          instead of one long vertical stack. `items-start` keeps each card
          at its natural height rather than stretching to match its neighbour. */}
