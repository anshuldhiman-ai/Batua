...
export default function Dashboard() {
  ...
  const load = React.useCallback(async () => {
    try {
      ...
      // Scope the category donut to the same month as the KPIs and Top-5 list.
      // Fetched without a month it returns all-time spend, which then silently
      // disagrees with the this-month Top-5 list shown right beside it.
      const b = await api.get("/analytics/category-breakdown", {
