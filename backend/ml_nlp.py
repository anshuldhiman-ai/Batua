...
CATEGORY_KEYWORDS: Dict[str, List[str]] = {
    ...
    "Refreshments": [
        "juice", "fresh juice", "fruit juice", "orange juice", "mango juice",
        "lemon juice", "lemonade", "nimbu", "nimbu pani", "nimboo", "shikanji",
        "mineral water", "bottled water", "packaged water", "drinking water",
        "bisleri", "kinley", "aquafina", "soft drink", "soft drinks",
        "cold drink", "cold drinks", "coke", "coca cola", "pepsi", "sprite",
        "fanta", "thums up", "thumbs up", "limca", "7up", "seven up", "7-up",
        "maaza", "frooti", "slice", "appy", "appy fizz", "soda", "soda water",
        "sparkling water", "sherbet", "sharbat", "rasna", "real juice",
        "lime water", "lime soda", "lime juice", "fresh lime", "lemon soda",
        "minute maid", "minutemaid",
    ],
    # Beverages BEFORE Fruits so "banana shake" is a drink, not a fruit. Hot
    # chai/coffee intentionally stays in Snacks.
    "Beverages": [
        "shake", "shakes", "milkshake", "milk shake", "milk-shake",
        "smoothie", "smoothies", "lassi", "chaas", "chhaas", "buttermilk",
        "butter milk", "cold coffee", "iced coffee", "ice coffee",
        "iced tea", "ice tea", "energy drink", "energy drinks", "red bull",
        "monster", "sting", "boost", "horlicks", "bournvita", "complan",
        "protein shake", "whey shake", "malt drink",
    ],
    # Fruits BEFORE Groceries & Snacks so "mango"/"banana" don't fall into the
    # grocery/snack buckets (but AFTER Refreshments/Beverages so fruit *drinks*
    # classify as drinks).
    "Fruits": [
        "mango", "mangoes", "aam", "raw mango", "banana", "bananas", "apple",
        "apples", "orange", "oranges", "grapes", "watermelon", "muskmelon",
        "musk melon", "papaya", "papayas", "guava", "guavas", "pineapple",
        "pomegranate", "kiwi", "strawberry", "strawberries", "mosambi",
        "sweet lime", "litchi", "lychee", "peach", "peaches", "plum", "apricot",
        "cherry", "cherries", "sapota", "chikoo", "custard apple", "jamun",
        "fruit", "fruits", "seasonal fruit", "fruit salad", "fruit bowl",
        "fruit market", "fruit vendor", "fruit stall",
    ],
    ...
    "Snacks": [
        ...
        "laddu", "coffee", "cake", "cup cake", "brownie",
    ],
    ...
    "Groceries": [
        ...
        "super market", "vegetables", "veggies",
        "mother dairy", "amul", "amul milk", "bread", "eggs", "milk",
...
TRAINING_DATA_FALLBACK: List[Tuple[str, str]] = [
    ...
    ("sprite", "Refreshments"),
    ("fanta", "Refreshments"),
    ("thums up", "Refreshments"),
    ("limca", "Refreshments"),
    ("maaza", "Refreshments"),
    ("frooti", "Refreshments"),
    ("slice", "Refreshments"),
    ("appy", "Refreshments"),
    ("real juice", "Refreshments"),
    ("real", "Refreshments"),
    ("ice cream", "Snacks"),
    ("icecream", "Snacks"),
    ("gelato", "Snacks"),
