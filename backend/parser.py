...
CATEGORIES: dict[str, list[str]] = {
    ...
    "Groceries": [
        ...
        "fruits", "rice", "wheat", "flour", "atta", "dal", "lentils",
        "oil", "ghee", "butter", "cheese", "eggs", "meat", "chicken",
        "fish", "bread", "biscuits", "sugar", "salt", "spices", "tea",
        "coffee", "curd", "yogurt", "paneer", "tofu", "soya", "nuts",
        "dry fruits", "almonds", "cashews", "raisins", "honey", "jam",
        "sauce", "ketchup", "pickles", "papad", "snacks", "namkeen",
        "chocolate", "ice cream", "cold drinks", "water", "mineral water",
        "bottled water", "cooking oil", "mustard oil", "sunflower oil",
        "olive oil", "refined oil", "soap", "detergent", "cleaning",
        "household", "daily needs", "provisions", "ration",
    ],
    "Fuel": [
    ...
    "Transportation": [
        ...
        "spicejet", "toll", "parking", "ticket", "booking", "reservation",
        "travel", "trip", "journey", "commute", "fare", "distance",
        "fuel", "petrol pump", "gas station", "cng", "diesel", "lpg",
        "vehicle", "car", "bike", "scooter", "motorcycle", "cycle",
        "maintenance", "service", "repair", "tyre", "tire", "battery",
        "insurance", "road tax", "fastag", "toll tax", "challan", "fine",
    ],
    "Shopping": [
        ...
        "laptop", "mobile", "phone", "tablet", "camera", "speaker", "earphones",
        "earbuds", "headset", "keyboard", "mouse", "monitor", "printer",
        "furniture", "sofa", "bed", "table", "chair", "curtains", "bedsheet",
        "decor", "gift", "present", "toys", "games", "console", "accessories",
        "bag", "purse", "wallet", "belt", "sunglasses", "jewelry", "makeup",
        "skincare", "cosmetics", "perfume", "fragrance", "shampoo", "conditioner",
        "soap", "lotion", "cream", "face wash", "body wash", "toothpaste",
        "brush", "comb", "towel", "tissues", "napkins", "diapers", "baby",
        "kids", "children", "men", "women", "unisex", "brand", "store", "shop",
    ],
    "Utilities": [
    ...
    "Entertainment": [
        ...
        "netflix", "spotify", "prime", "hotstar", "disney", "sony liv",
        "youtube", "youtube premium", "music", "audio", "video", "streaming",
        "event", "show", "performance", "festival", "fair", "exhibition",
        "theme park", "water park", "adventure", "sports", "match", "cricket",
        "football", "basketball", "tennis", "badminton", "golf", "club",
    ],
    "Health": [
        "pharmacy", "medical", "doctor", "hospital", "medicine", "apollo",
        "pharmeasy", "1mg", "netmeds", "clinic", "dental", "health", "lab",
        "tablet", "capsule", "syrup", "injection", "vaccine", "test",
        "checkup", "consultation", "surgery", "operation", "treatment",
        "therapy", "physiotherapy", "yoga", "fitness", "gym", "wellness",
        "supplement", "vitamin", "protein", "nutrition", "diet", "weight",
        "insurance", "claim", "policy", "premium", "eye", "dental",
        "skin", "hair", "mental", "stress", "anxiety", "depression",
    ],
    "Education": [
        "course", "udemy", "coursera", "school", "college", "tuition",
        "books", "exam", "fees", "byju", "unacademy", "vedantu",
        "class", "lecture", "tutorial", "workshop", "seminar",
        "training", "certification", "certificate", "degree", "diploma",
        "online course", "e-learning", "distance learning", "home study",
        "library", "stationery", "supplies", "uniform", "hostel",
        "mess", "canteen", "admission", "registration", "enrollment",
        "scholarship", "grant", "fellowship", "internship", "apprenticeship",
    ],
    "Housing/Rent": [
    ...
    "Personal Care": [
        ...
        "hair", "beard", "shave", "trim", "style", "color", "dye",
        "facial", "manicure", "pedicure", "massage", "therapy", "wellness",
        "beauty", "grooming", "hygiene", "personal", "care", "products",
        "cream", "lotion", "oil", "serum", "mask", "scrub", "peel",
        "perfume", "cologne", "deodorant", "fragrance", "scent",
        "razor", "blade", "trimmer", "clipper", "brush", "comb",
        "towel", "tissue", "napkin", "sanitizer", "wipes", "cotton",
    ],
}
